...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      detailInfo: "Orders",
      user: this.templateData.data["".concat(_typeof(this.templateData.data.guest) === 'object' ? 'guest' : 'user')],
      shipping: this.templateData.data["".concat(_typeof(this.templateData.data.guest) === 'object' ? 'guest' : 'user')].shipping || {}
    };
  },
  computed: {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      style: {
        background:
          typeof _vm.templateData.data.guest === "object"
            ? "rgba(142, 17, 30, 0.16)"
            : "rgba(0, 142, 109, 0.16)"
      }
    },
      ...
      _c("div", { staticClass: "container-info" }, [
        ...
        _c("div", { staticClass: "info" }, [
          ...
          _c("div", [
            ...
            _c("div", [
              _vm._v(
                _vm._s((_vm.user.phone && _vm.phone(_vm.user.phone)) || "-----")
              )
            ])
          ]),
          _vm._v(" "),
