    ...
    [
      ...
      _c(
        "vs-prompt",
        {
          attrs: {
            "vs-title":
              _vm.showTable === true ? "Create Bundle" : "Create Single",
            "vs-accept-text": "Send",
              ...
              _c(
                ...
                [
                  ...
                  _c("vs-input", {
                    ...
                    attrs: { "label-placeholder": "Part Number" },
                    model: {
                      value: _vm.partNum,
                      callback: function($$v) {
                        _vm.partNum = $$v
                  ...
                  _c("vs-input", {
                    staticClass: "w-full mb-6",
                    attrs: { "label-placeholder": "Description" },
                    model: {
                  ...
                  _c("vs-input", {
                    staticClass: "w-full mb-6",
                    attrs: { "label-placeholder": "Description Full" },
                    model: {
                  ...
                  _c("vs-input", {
                    staticClass: "w-full mb-6",
                    attrs: { "label-placeholder": "Min Stock" },
                    model: {
                      value: _vm.minStock,
                      callback: function($$v) {
                        _vm.minStock = $$v
                  ...
                  _vm.showTable === true
                    ...
                    : _c("vs-input", {
                        staticClass: "w-full mb-6",
                        attrs: { "label-placeholder": "Current" },
                        model: {
                          value: _vm.current,
                          callback: function($$v) {
                            _vm.current = $$v
                  ...
                  _c("vs-input", {
                    staticClass: "w-full mb-6",
                    attrs: { "label-placeholder": "Min Price" },
                    model: {
                      value: _vm.minPrice,
                      callback: function($$v) {
                        _vm.minPrice = $$v
                  ...
                  _c("vs-input", {
                    staticClass: "w-full mb-6",
                    attrs: { "label-placeholder": "Location" },
                    model: {
                      value: _vm.location,
                      callback: function($$v) {
                        _vm.location = $$v
                  ...
                  _vm._v(" "),
                  _c("p", [_vm._v("here will be input chip")]),
                  _vm._v(" "),
                  _c("vs-input", {
                    staticClass: "w-full mb-6",
                    attrs: { "label-placeholder": "Categories" },
                    model: {
