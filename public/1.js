...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.moduleStock.bundle_parts = this.moduleStock.bundle_pivot ? this.moduleStock.bundle_pivot.map(function (item) {
      var bundle_parts = item.bundle_parts[0];
      var bundle_part_data = bundle_parts.bundle_part_data;
      return {
    ...
    var arr = [];
    this.moduleStock.bundle_parts = this.moduleStock.bundle_parts.map(function (item) {
  ...
  methods: {
    ...
    saveChanges: function saveChanges(val) {
      var arr = [];
      this.moduleStock.bundle_parts = val.map(function (item) {
        arr.push(Math.floor(parseInt(item.qty) / parseInt(item.bundle_qty)));
        return item;
      });
      arr = arr.filter(function (i) {
    ...
    create: function create() {
      ...
      var order = this.$store.getters['stockCaModule/GET_DATA_STOCK_ORDER']; // .replace(/[\s()-]+/gi, '');
      ...
      if (this.moduleStock.action == 'update') {
        ...
        this.$store.dispatch("stockCaModule/UPDATE_DATA_STOCK", module).then(function () {
          ...
          _this.$store.dispatch("GET_SHOW_BUNDLE_SINGLE", {
            module: false,
            showTable: false
          });

          _this.$store.commit('isNoActive', false);
        })["catch"](function () {
                  ...
                  [
                    ...
                    _c(
                      ...
                      [
                        _c("vs-input", {
                          ...
                          model: {
                            value: _vm.moduleStock.weight,
                            callback: function($$v) {
                              _vm.$set(_vm.moduleStock, "weight", $$v)
                            },
                            expression: "moduleStock.weight"
                          }
                        }),
                        _vm._v(" "),
                        _c("vs-input", {
                          ...
                          model: {
                            value: _vm.moduleStock.length,
                            callback: function($$v) {
                              _vm.$set(_vm.moduleStock, "length", $$v)
                            },
                            expression: "moduleStock.length"
                          }
                        }),
                        _vm._v(" "),
                        _c("vs-input", {
                          ...
                          model: {
                            value: _vm.moduleStock.width,
                            callback: function($$v) {
                              _vm.$set(_vm.moduleStock, "width", $$v)
                            },
                            expression: "moduleStock.width"
                          }
                        }),
                        _vm._v(" "),
                        _c("vs-input", {
                          ...
                          model: {
                            value: _vm.moduleStock.depth,
                            callback: function($$v) {
                              _vm.$set(_vm.moduleStock, "depth", $$v)
                            },
                            expression: "moduleStock.depth"
                          }
                        })
                      ],
                      1
                    ...
                    _c("vs-textarea", {
                      ...
                      model: {
                        ...
                        callback: function($$v) {
                          _vm.$set(_vm.moduleStock, "fits", $$v)
                        },
                        expression: "moduleStock.fits"
                      }
                    }),
                    _vm._v(" "),
                    _c("vs-textarea", {
                      ...
                      model: {
                        ...
                        callback: function($$v) {
                          _vm.$set(_vm.moduleStock, "important_general", $$v)
                        },
